...
class World {
  ...
  constructor(public canvas: HTMLCanvasElement) {
    this.context = <WebGLRenderingContext>canvas.getContext('webgl');
  ...
  */
  initializeShader(source: string, type: number) {
  ...
  */
  initializeProgram(vertex_shader_source: string, fragment_shader_source: string) {
